  ...
  return (
    <div className="flex h-screen flex-col items-center justify-center gap-6 p-4 text-center bg-gradient-to-b from-background to-muted/30">
      <div className="bg-background/80 p-8 rounded-xl shadow-lg backdrop-blur-sm max-w-md w-full border border-border">
        <div className="mb-6">
          {isOnline ? (
            <div className="h-24 w-24 mx-auto rounded-full bg-green-100 dark:bg-green-900/30 flex items-center justify-center text-green-600 dark:text-green-400">
              <Wifi size={48} />
            </div>
          ) : (
            <div className="h-24 w-24 mx-auto rounded-full bg-red-100 dark:bg-red-900/30 flex items-center justify-center text-red-600 dark:text-red-400">
              <WifiOff size={48} />
            </div>
          )}
        </div>
